...
echo ""
echo "Note: The create_talktale_ppt.py script uses '맑은 고딕' (Malgun Gothic)"
echo "which may not be available on Raspberry Pi. Consider updating the script"
echo "to use 'NanumGothic' instead for better compatibility."
echo ""
